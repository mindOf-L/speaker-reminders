...
public class Messages {
    ...
    public static final String
        EMAIL_DEFAULT_SUBJECT = "TEST! Torrejón de Ardoz - Veredillas: Recordatorio de discurso público para esta semana",
        EMAIL_NOT_INFORMED_SUBJECT = "TEST! Email de discursante no informado: %s",
